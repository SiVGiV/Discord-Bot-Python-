...
@slash.subcommand(
    ...
    options=[
        ...
        mal.create_option(
            ...
            choices=list(map(
                lambda x: mal.create_choice(name=x[1]['name'], value=x[0]),
...
@slash.subcommand(
    ...
    options=[
        ...
        mal.create_option(
            ...
            description="Convert from",
            choices=[
                mal.create_choice(name="celsius", value="c"),
                mal.create_choice(name="fahrenheit", value="f"),
                mal.create_choice(name="kelvin", value="k")
            ]
        ),
        mal.create_option(
            name="to",
